...
module README and [`catalog/modules.yaml`](../catalog/modules.yaml) describe
...
Run [`scripts/tools/validate-outputs.py`](../scripts/tools/validate-outputs.py)
...
[`.terraform-docs.yml`](../.terraform-docs.yml). Keep generated content
...
2. Add the complete standard structure, a focused README, a basic example, and
   native tests.
3. Add the module to [`catalog/modules.yaml`](../catalog/modules.yaml) using
